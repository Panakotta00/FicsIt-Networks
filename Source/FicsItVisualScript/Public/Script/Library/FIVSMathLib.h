...
class UFIVSMathLib : public UObject {
	GENERATED_BODY()
public:
	FIVSNode_BeginLuaGenericMeta(FIVSFunc_Float_Addition, "Addition (float)", "+", "Adds two Floats", "Math|float")
	...
	FIVSNode_BeginLuaGenericMeta(FIVSFunc_Int_Subtraction, "Subtraction (int)", "-", "Subtracts two Floats", "Math|int")
	FIVSNode_LuaGenericPin("X" , "X", FIVS_PIN_DATA_INPUT, FIR_INT)
	FIVSNode_LuaGenericPin("Y" , "Y", FIVS_PIN_DATA_INPUT, FIR_INT)
	...
	FIVSNode_BeginLuaGenericMeta(FIVSFunc_Int_Multiply, "Multiplication (int)", "*", "Multiplies two Floats", "Math|int")
	FIVSNode_LuaGenericPin("X" , "X", FIVS_PIN_DATA_INPUT, FIR_INT)
	FIVSNode_LuaGenericPin("Y" , "Y", FIVS_PIN_DATA_INPUT, FIR_INT)
	...
	FIVSNode_BeginLuaGenericMeta(FIVSFunc_Int_Divide, "Division (int)", "/", "Divides two Floats", "Math|int")
	FIVSNode_LuaGenericPin("X" , "X", FIVS_PIN_DATA_INPUT, FIR_INT)
	FIVSNode_LuaGenericPin("Y" , "Y", FIVS_PIN_DATA_INPUT, FIR_INT)
