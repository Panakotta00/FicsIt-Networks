...
USTRUCT()
struct FICSITNETWORKSCIRCUIT_API FFINCablePlacementStepInfo {
	GENERATED_BODY()
...
class FICSITNETWORKSCIRCUIT_API AFINNetworkCableHologram : public AFGBuildableHologram {
	GENERATED_BODY()
...
public:
	...
	UPROPERTY()
	class USplineMeshComponent* Cable = nullptr;
