...
UCLASS()
class FICSITNETWORKSCIRCUIT_API UFINCDWirelessAccessPointRequiresTower : public UFGConstructDisqualifier {
	GENERATED_BODY()
...
UCLASS()
class FICSITNETWORKSCIRCUIT_API AFINWirelessAccessPointHologram : public AFGBuildableHologram {
	GENERATED_BODY()
