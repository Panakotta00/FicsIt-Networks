...
void AFINWirelessSubsystem::RecalculateWirelessConnections() {
	...
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("Recalculating Wireless Connections"));
...
TArray<UFINWirelessAccessPointConnection*> AFINWirelessSubsystem::GetAvailableConnections(AFINWirelessAccessPoint* CurrentAccessPoint) {
	...
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("Found %d (%d valid) radar towers"), CachedRadarTowers.Num(), RadarTowers.Num());
...
void AFINWirelessSubsystem::BeginPlay() {
	...
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("Wireless Subsystem started"));
}

void AFINWirelessSubsystem::CacheTowersAndAccessPoints() {
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("Wireless Subsystem: caching towers & wap"));
	...
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("Found %d Radar Towers"), CachedRadarTowers.Num());
	...
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("Found %d Access Points"), CachedAccessPoints.Num());
}
