...
void AFINWirelessAccessPoint::BeginPlay() {
	...
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("FINWirelessAccessPoint::BeginPlay"));
	if (HasAuthority()) {
...
void AFINWirelessAccessPoint::OnRep_WirelessConnectionsData() {
	UE_LOG(LogFicsItNetworksCircuit, Display, TEXT("OnRep_WirelessConnectionsData received %d connections"), mAvailableWirelessConnectionsData.Num());
