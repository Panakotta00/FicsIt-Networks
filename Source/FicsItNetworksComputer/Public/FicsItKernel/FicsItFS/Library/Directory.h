...
namespace CodersFileSystem {
	...
	class FICSITNETWORKSCOMPUTER_API Directory : public Node {
	public:
		Directory();
		virtual ~Directory();
	...
	class FICSITNETWORKSCOMPUTER_API MemDirectory : public Directory {
	protected:
	...
	class FICSITNETWORKSCOMPUTER_API DiskDirectory : public Directory {
	protected:
