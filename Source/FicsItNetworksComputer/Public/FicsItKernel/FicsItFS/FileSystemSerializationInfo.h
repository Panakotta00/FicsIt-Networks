...
USTRUCT()
struct FICSITNETWORKSCOMPUTER_API FFileSystemNodeIndex {
	GENERATED_BODY()
...
USTRUCT()
struct FICSITNETWORKSCOMPUTER_API FFileSystemNode {
	GENERATED_BODY()
...
USTRUCT()
struct FICSITNETWORKSCOMPUTER_API FFileSystemSerializationInfo {
	GENERATED_BODY()
