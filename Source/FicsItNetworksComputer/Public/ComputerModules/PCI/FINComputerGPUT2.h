...
struct FICSITNETWORKSCOMPUTER_API FFINGPUT2DC_PushTransform : public FFINGPUT2DrawCall {
	...
	UPROPERTY(SaveGame)
	FVector2D Translation = FVector2D::Zero();
...
struct FICSITNETWORKSCOMPUTER_API FFINGPUT2DC_PushClipPolygon : public FFINGPUT2DrawCall {
	...
	UPROPERTY(SaveGame)
	FVector2D TopLeft = FVector2D::Zero();

	UPROPERTY(SaveGame)
	FVector2D TopRight = FVector2D::Zero();

	UPROPERTY(SaveGame)
	FVector2D BottomLeft = FVector2D::Zero();

	UPROPERTY(SaveGame)
	FVector2D BottomRight = FVector2D::Zero();
...
struct FICSITNETWORKSCOMPUTER_API FFINGPUT2DC_Spline : public FFINGPUT2DrawCall {
	...
	UPROPERTY(SaveGame)
	FVector2D StartDirection = FVector2D::Zero();

	UPROPERTY(SaveGame)
	FVector2D End = FVector2D::Zero();

	UPROPERTY(SaveGame)
	FVector2D EndDirection = FVector2D::Zero();
