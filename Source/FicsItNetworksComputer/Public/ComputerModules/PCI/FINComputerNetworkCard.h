...
UCLASS()
class FICSITNETWORKSCOMPUTER_API AFINComputerNetworkCard : public AFINComputerModule, public IFINNetworkCircuitNode, public IFINNetworkComponent, public IFINNetworkMessageInterface, public IFINPciDeviceInterface {
	GENERATED_BODY()
public:
	/**
	...
	*/
	...
	virtual void HandleMessage(const FGuid& InID, const FGuid& Sender, const FGuid& Receiver, int Port, const TArray<FFIRAnyValue>& Data) override;
	...
	static bool CheckNetMessageData(const TArray<FFIRAnyValue>& Data);
