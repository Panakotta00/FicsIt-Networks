...
public:
	...
	static void AddFunction(UClass* Class, int FuncID, const FString& InternalName, const FText& DisplayName, const FText& Description, bool VarArgs,  const TFunction<void(const FINTrace&, TArray<FINAny>&)>& Func);
	template<typename T>
	...
	template<typename T>
	static void AddProp(UClass* Class, int PropID, const FString& InternalName, const FText& DisplayName, const FText& Description, const TFunction<FINAny(void*)>& Get) {
