...
namespace FINLua {
	 ...
	 * @deprecated 
	 */
	[[deprecated]] int luaCallFINFunc(lua_State* L, UFINFunction* Func, const FFINExecutionContext& Ctx, const std::string& typeName);

	/**
	 * Trys to find function or property by membername in the given struct. Uses also given cache.
	 * @deprecated 
	 */
	[[deprecated]] int luaFindGetMember(lua_State* L, UFINStruct* Struct, const FFINExecutionContext& Ctx, const FString& MemberName, const FString& MetaName, int(*callFunc)(lua_State*), bool classInstance);

	/**
	 * Trys to find property by memebername and sets the value in the given struct. Uses also given cache.
	 * @deprecated 
	 */
	[[deprecated]] int luaFindSetMember(lua_State* L, UFINStruct* Struct, const FFINExecutionContext& Ctx, const FString& MemberName, bool classInstance, bool bCauseError = true);
