...
In addition to their GUID, Network Components can also have a *nick* (short for "nickname"). A nick is one or more custom names separated by spaces. Any component can be given a nick using the Network Manager.
