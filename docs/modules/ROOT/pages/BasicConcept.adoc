...
- `Class` - Unordered collection of data and functions

That's right! Even a class is a type!
...
- *()* - Parentheses indicate a list of the inputs and outputs of the function (known as "arguments") separated by commas
...
We can call the function by using something called "dot notation":
