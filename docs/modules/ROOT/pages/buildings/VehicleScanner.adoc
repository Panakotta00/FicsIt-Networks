= Vehicle Scanner
:description: The vehicle scanner looks nice and allows for communiction with vehicles driving over it.
...
The vehcile scanner is a computer network component that looks nice and on the top of it,
allows you to communicate with the vehicles that drive over it.

You can also dynamicly change the color of the scanner beams.
