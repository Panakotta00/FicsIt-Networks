...
Each character can have its own background and foreground color.
...
keyboard keystrokes or just simple mouse movement over the screen.
...
won't change. (Until you draw them again)
