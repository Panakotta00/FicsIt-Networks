= Indicator Pole
:description: The indicator pole allows you to display a state of program so you can determine it from far away.
...
connect every pole itself to a computer network.
