...
! Display Name ! Gravitational Force
!===
====
...
=== `getCouplerRotationAndExtension` (`coupler` : Int) -> (`x` : Float, `y` : Float, `z` : Float, `extension` : Float)
...
! Display Name ! Get Coupler Rotation And Extension
!===
