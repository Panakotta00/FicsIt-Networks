...
The function allows you to get information about the length of the track.
...
==== `bool isOwnedByPlatform()`

This function allows you to check if the track is owned by a platform.
...
This function allows you to check if the connector is connected to another connector.
...
|bool
|bool
|True if the connector is connector to another one.
|===

==== `bool isFacingSwitch()`

This function allows you to check if the connection is facing the switch.
...
|bool
|bool
|True if the connector is facing the switch.
|===

==== `bool isTrailingSwitch()`

This function alllows you to check the the connection is trailing the switch.
...
|bool
|bool
|True if the connector is trailing the switch.
|===

==== `int getNumSwitchPosition()`

This function retrieves the count of posible switch positions.
...
This functions returns the current selected switch position.
...
|int
|int
|The current selected switch position.
|===
...
==== `setInLoadMode(bool loadMode)`

Sets if the docking station is in load mode.
...
|loadMode
|bool
|True if the dockin station should be in load mode.
|===

==== `bool isLoadMode()`

Returns if the dockingstation is currently in load mode or not.
...
|bool
|bool
|True if the docking station is currently in load mode.
|===

==== `bool isLoadUnloading()`

Returns if the dockingstation is currently loading or unloading the docked actor.
...
|bool
|bool
|True if the docking station is currently loading or unloading.
|===
...
==== `number getFluidContent()`

This function returns the amount of fluid currently stored in the container.
...
|number
|number
|The amount of fluid currently stored in the storage.
|===

==== `number getMaxFluidContent()`

This function returns how much fluid this storage container can hold.
...
|number
|number
|The amount of fluid the storage container can hold.
|===

==== `number getFlowFill()`

This function returns the rate how fast the container gets filled with fluid.
...
|number
|number
|The rate in which the container gets filled with fluid.
|===

==== `numer getFlowDrain()`

This function returns the rate how fast the container gets drained.
...
|number
|number
|The rate in which the container gets drained.
|===

==== `numer getFlowLimit()`

This function returns the max fluid transfer rate of the container.
