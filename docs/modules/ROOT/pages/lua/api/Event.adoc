...
Removes the running lua context from the listen queue of the given component.
...
|Component
|Component
|The network component lua representation the computer should stop listening to.
|===
