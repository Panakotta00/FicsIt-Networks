...
image::buildings/Example_Paint_Internal-Screen_Editor.png[ width = 300 , height = 300 , role=right ]
...
image::buildings/Example_Paint_Large-Screen_Hardware.png[ width = 300 , height = 300 , role=right ]
...
image::buildings/Example_Paint_Internal-Screen_Hardware.png[ width = 300 , height = 300 , role = right ]
