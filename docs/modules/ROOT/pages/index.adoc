...
FicsIt-Networks is a mod for Satisfactory written in >= SML 2.0 which allows you to control, monitor, manage and automate each process of your factory by providing a network system and programmable computers and other I/O.
