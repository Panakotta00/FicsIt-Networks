= Network Manager
:description: This is a multi tool for network administration.
...
This window will show you the UUID of the component, allows you to change and view the nickname,
...
The network manager also provides the reflection viewer which you can explore and
