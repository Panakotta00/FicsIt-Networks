...
void ANetworkCable_Holo::construct() {
	...
	if (!mesh) mesh = (SDK::UStaticMesh*) Functions::loadObjectFromPak(SDK::UStaticMesh::StaticClass(), L"/Game/FactoryGame/SatisfyingComputers/ComputerNetwork/NetworkCable/Mesh_NetworkCable.Mesh_NetworkCable");
	...
	if (!meshCon) meshCon = (SDK::UStaticMesh*)Functions::loadObjectFromPak(SDK::UStaticMesh::StaticClass(), L"/Game/FactoryGame/SatisfyingComputers/ComputerNetwork/Mesh_NetworkConnector_Holo.Mesh_NetworkConnector_Holo");
