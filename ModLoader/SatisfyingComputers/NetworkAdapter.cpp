...
void ANetworkAdapter::constructor() {
	...
	if (!mesh) mesh = (SDK::UStaticMesh*)Functions::loadObjectFromPak(SDK::UStaticMesh::StaticClass(), L"/Game/FactoryGame/SatisfyingComputers/ComputerNetwork/Mesh_NetworkConnector.Mesh_NetworkConnector");
