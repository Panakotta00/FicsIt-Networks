...
void loadClasses() {
	...
	Paks::ClassBuilder<UNetworkComponent>::Interface()
		...
		.func(Paks::FunctionBuilder::method("getNick").native(&UNetworkComponent::getNick_exec).addFuncFlags(EFunctionFlags::FUNC_Event | EFunctionFlags::FUNC_BlueprintEvent | EFunctionFlags::FUNC_Const).param(Paks::PropertyBuilder::retVal(EPropertyClass::Str, "retVal")))
		.func(Paks::FunctionBuilder::method("setNick").native(&UNetworkComponent::setNick_exec).addFuncFlags(EFunctionFlags::FUNC_Event | EFunctionFlags::FUNC_BlueprintEvent).param(Paks::PropertyBuilder::param(EPropertyClass::Str, "nick")))
	...
	Paks::ClassBuilder<UNetworkConnector>::Basic()
		...
		.prop(Paks::PropertyBuilder::attrib(EPropertyClass::Str, "nick").saveGame())
